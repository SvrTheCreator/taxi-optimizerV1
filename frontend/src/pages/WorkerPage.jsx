      ...
      <section className="shifts-section">
        ...
        {!profileKnown && profileError && (
          <div className="connection-banner">
            ...
            Кнопки смен неактивны, потому что не загрузились ваши данные.
            Адрес никуда не пропал — вводить его заново <b>не нужно</b>.
            <ol>
              <li>Подключитесь к <b>Wi-Fi</b> — так надёжнее всего</li>
              <li>Или выключите и снова включите мобильный интернет</li>
